...
\begin{document}
	...
	En 2017 y 2019 se realizaron dos experimentos en bloques aleatorizados para evaluar los factores que influyen en la distribución de semillas en un cabezal distribuidor de 6 salidas. En estos cabezales se espera que salga el mismo flujo de semilas en cada salida, que se cumple en buena medida con semillas pequeñas pero se encuentran diferentes proporciones en semillas de tamaño mayor, como es el caso de la soja.
	
	- evaluación de detección por placa
	- evaluación de detección por arreglo infrarojo    
    
    
    equipamiento utilizado
    - placas con piezo
    - pares de emisor - receptor infrarojo
    - placa de sonido de computadora
    - adquisidor de datos HBM
    - placa de desarrollo con ESP32
    - Cámara de alta velocidad Fastec
    
    herramientas para análisis de datos    
    - python con los paquetes numpy y Pandas
    - R
