...
\begin{document}
    ...
    \section*{Resumen}
    %Tema a tratar
    El el presente artículo se presenta el avance del plan de tesis de doctorado de Sebastián Rossi. Los trabajos presentados son de carácter experimental y exploratorios. 
    
    lineamientos metodologicos
    
    eje argumentativo
    
    conclusión más relevaste
